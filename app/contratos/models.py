...
class Contrato(models.Model):
    ...
    valor_del_contrato = models.DecimalField(max_digits=50, decimal_places=2)
    valor_de_pago_adelantado = models.DecimalField(max_digits=50, decimal_places=2, default=0)
    valor_facturado = models.DecimalField(max_digits=50, decimal_places=2, default=0)
    valor_pendiente_de_pago = models.DecimalField(max_digits=50, decimal_places=2, default=0)
    valor_pagado = models.DecimalField(max_digits=50, decimal_places=2, default=0)
    valor_amortizado = models.DecimalField(max_digits=50, decimal_places=2, default=0)
    valor_pendiente_de = models.DecimalField(max_digits=50, decimal_places=2, default=0)
    valor_pendiente_de_ejecucion = models.DecimalField(max_digits=50, decimal_places=2, default=0)
    ...
    saldo_cdp = models.DecimalField(max_digits=50, decimal_places=2, default=0)
    saldo_vigencia = models.DecimalField(max_digits=50, decimal_places=2, default=0)
    ...
    presupuesto_general_de_la_nacion_pgn = models.DecimalField(max_digits=50, decimal_places=2, default=0)
    sistema_general_de_participaciones = models.DecimalField(max_digits=50, decimal_places=2, default=0)
    sistema_general_de_regalias = models.DecimalField(max_digits=50, decimal_places=2, default=0)
    recursos_propios_alcaldias_gobernaciones_y_resguardos_indigenas = models.DecimalField(max_digits=50, decimal_places=2, default=0)
    recursos_de_credito = models.DecimalField(max_digits=50, decimal_places=2, default=0)
    recursos_propios = models.DecimalField(max_digits=50, decimal_places=2, default=0)
